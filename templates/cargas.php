        ...
        <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" placeholder="Condiciones clinicas">
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <div class="form-group col-md-4">
                    ...
                    <textarea class="form-control" placeholder="Actividad 1" required></textarea>        
                </div>
                <div class="form-group col-md-4">
                    <label>Actividad 2</label>
                    <textarea class="form-control" placeholder="Actividad 2" required></textarea>        
                </div>
                <div class="form-group col-md-4">
                    <label>Actividad 3</label>
                    <textarea class="form-control" placeholder="Actividad 3" required></textarea>        
                </div>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
                <div class="form-group col-md-12">
                    <label>Observacion de estudios</label>
                    <textarea class="form-control" placeholder="Observacion de estudios" required></textarea>        
                </div>
            </div>
